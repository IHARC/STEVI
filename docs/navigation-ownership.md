...
- `src/lib/portal-navigation.ts` – Operations rails (ops_frontline, ops_org, ops_admin) covering Today, Clients, Programs, Inventory, Partners, Org hub, and STEVI Admin hub. Visit creation is a hub action, not a global hub.

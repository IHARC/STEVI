...
const baseAccess: PortalAccess = {
  ...
  isIharcMember: true,
  orgRoles: [{ id: 'role-1', name: 'iharc_staff', displayName: 'IHARC Staff', roleKind: 'staff' }],
  ...
  canReportCosts: true,
  canAdminCosts: true,
  canReadSensitiveObservations: true,
  canReadRestrictedObservations: true,
  canPromoteObservations: true,
  canTrackTime: false,
  ...
  canUpdateCfs: false,
  canTriageCfs: false,
  canDispatchCfs: false,
  canShareCfs: false,
  canPublicTrackCfs: false,
  canDeleteCfs: false,
  canAccessCfs: false,

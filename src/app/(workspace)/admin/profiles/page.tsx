...
import { PendingAffiliationsSection } from '@workspace/admin/profiles/pending-affiliations';
import { InvitePartnerCard } from '@workspace/admin/profiles/invite-partner-card';
import { resolveLandingPath } from '@/lib/portal-navigation';
import type {
  OrganizationOption,
  PendingAffiliation,
  ProfileInviteSummary,
} from '@workspace/admin/profiles/types';

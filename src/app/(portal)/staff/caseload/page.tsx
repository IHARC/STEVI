  ...
  return (
    <div className="space-y-space-lg">
      <header className="space-y-space-2xs">
        ...
        <h1 className="text-headline-lg text-on-surface">Active cases</h1>
      ...
      <div className="grid gap-space-md md:grid-cols-2">
          ...
          <Card key={item.id} className="h-full">
            <CardHeader className="flex flex-row items-start justify-between gap-space-sm">
              <div className="space-y-space-3xs">
                <CardTitle className="text-title-md">{item.clientName}</CardTitle>
        ...
        {caseload.length === 0 ? (
          <Card>
            <CardHeader>
              <CardTitle className="text-title-md">No active cases</CardTitle>

      ...
      <form action={action} className="space-y-6">
        ...
        <fieldset className="grid gap-4 md:grid-cols-2">
          ...
          <div className="grid gap-2">
            ...
            />
            <p className="text-xs text-foreground/60">Use lower-case keywords so filters stay consistent.</p>
          </div>
          <div className="grid gap-2">
            ...
            />
            <p className="text-xs text-foreground/60">One per line using “Label | https://link”. Only trusted hosts should be listed.</p>
          </div>
        </fieldset>
        ...
        <fieldset className="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
          <div className="grid gap-2">
            ...
            <p className="text-xs text-foreground/60">Only trusted hosts are allowed. Snippets are sanitized before publishing.</p>
          </div>
          <div className="grid gap-2">
            ...
            <p className="text-xs text-foreground/60">Choose how the embed anchors alongside the written summary.</p>
          </div>
          <div className="grid gap-2">
            ...
            />
            <p className="text-xs text-foreground/60">Required for Google Docs, PDFs, videos, and external links.</p>
          </div>
          <div className="grid gap-2">
        ...
        <div className="flex flex-wrap gap-3">
          ...
          <Button asChild variant="ghost">
            <Link href="/app-admin/resources">Back to admin overview</Link>
          </Button>
        </div>
      </form>

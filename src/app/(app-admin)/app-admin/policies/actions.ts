...
export async function createPolicy(formData: FormData) {
  ...
  const adminPolicyPath = `/app-admin/policies/${slug}`;

  await revalidatePaths('/app-admin', '/app-admin/policies', adminPolicyPath, '/policies', `/policies/${slug}`, '/transparency', '/sitemap.xml');
}
...
export async function updatePolicy(formData: FormData) {
  ...
  const legacyAdminPath = currentSlug && currentSlug !== slug ? `/app-admin/policies/${currentSlug}` : null;
...
export async function deletePolicy(formData: FormData) {
  ...
  await revalidatePaths(
    ...
    policySlug ? `/app-admin/policies/${policySlug}` : null,
    '/transparency',
    '/sitemap.xml',
  );
}

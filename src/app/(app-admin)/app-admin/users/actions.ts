...
const LIST_ROOT = '/app-admin/users';
const SEGMENT_PATHS = ['/app-admin/users/all', '/app-admin/users/clients', '/app-admin/users/partners', '/app-admin/users/staff'] as const;

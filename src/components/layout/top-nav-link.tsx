...
export function TopNavLink({ href, children }: TopNavLinkProps) {
  ...
  return (
    <Link
      href={href}
      className={cn(
        'rounded-full px-2.5 py-1.5 text-sm font-medium transition focus:outline-none focus-visible:ring-2 focus-visible:ring-primary focus-visible:ring-offset-2 focus-visible:ring-offset-surface',

        ...
        {formVariant === 'sheet' ? (
          <Sheet>
            <SheetTrigger asChild>
              <Button variant="outline" size="sm">Add characteristic</Button>
            </SheetTrigger>
            <SheetContent className="overflow-y-auto sm:max-w-xl">
              <SheetHeader className="text-left">
                <SheetTitle>Add characteristic</SheetTitle>
                <SheetDescription>Record observable traits or measurements.</SheetDescription>
              </SheetHeader>

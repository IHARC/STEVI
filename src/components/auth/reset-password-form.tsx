  ...
  return (
    <form action={formAction} className="grid gap-6 rounded-2xl border border-outline/20 bg-surface p-6 shadow-subtle">
      <div className="space-y-2">
        <h1 className="text-3xl font-semibold tracking-tight text-on-surface">Reset your password</h1>
      ...
      <fieldset className="space-y-3 rounded-xl border border-outline/25 p-4">
        <legend className="text-sm font-semibold text-on-surface">Choose verification method</legend>
        <RadioGroup
          name="contact_method"
          value={contactMethod}
      ...
      {contactMethod === 'email' ? (
        <div className="grid gap-2">
          ...
          />
          <p className="text-xs text-muted">We will email a secure link to update your password.</p>
        </div>
      ) : (
        <>
          ...
          <div className="grid gap-2">
            ...
            <Input
              ...
              required={!otpPending}
            />
            <p className="text-xs text-muted">Include your country code so we can text you a verification code.</p>
          </div>

-- Drop legacy data_sharing_consent and update list RPC payload
...
create or replace function core.get_people_list_with_types(
  ...
  p_person_types core.person_type[] default null::core.person_type[],
  p_person_category core.person_category default null::core.person_category,
  p_status core.person_status default null::core.person_status,
...
alter table core.people drop column data_sharing_consent;

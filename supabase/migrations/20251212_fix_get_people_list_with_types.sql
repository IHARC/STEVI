-- Fix core.get_people_list_with_types return type mismatch.
-- Existing function returns housing_status/risk_level as text but selects enum values.
-- Pre-production: replace function cleanly, preserving privacy + sort logic.
